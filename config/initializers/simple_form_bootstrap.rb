...
SimpleForm.setup do |config|
  ...
  config.wrappers :check_inline, tag: 'div', class: 'form-group row', error_class: 'has-error' do |b|
    b.use :html5
    b.optional :readonly
    ...
    b.wrapper tag: 'div', class: 'col-sm-9' do |wr|
      wr.wrapper tag: 'div', class: 'checkbox' do |ba|
        ba.use :label_input,class: 'form-check-inline'
      end

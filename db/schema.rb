...
ActiveRecord::Schema.define(version: 20170115144915) do
  ...
  create_table "appointments", force: :cascade do |t|
    ...
    t.index ["call_log_id"], name: "index_appointments_on_call_log_id", using: :btree
  ...
  create_table "call_logs", force: :cascade do |t|
    ...
    t.datetime "updated_at",        null: false
    t.date     "date_of_call"
    t.index ["member_id"], name: "index_call_logs_on_member_id", using: :btree
    t.index ["user_id"], name: "index_call_logs_on_user_id", using: :btree
  end

  create_table "care_gaps", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "care_gaps_members", id: false, force: :cascade do |t|
    ...
    t.index ["care_gap_id"], name: "index_care_gaps_members_on_care_gap_id", using: :btree
    t.index ["member_id"], name: "index_care_gaps_members_on_member_id", using: :btree
  end

  create_table "completed_gaps", force: :cascade do |t|
    ...
    t.datetime "updated_at",         null: false
    t.integer  "member_id"
    t.index ["care_gap_id"], name: "index_completed_gaps_on_care_gap_id", using: :btree
    t.index ["doctor_id"], name: "index_completed_gaps_on_doctor_id", using: :btree
    t.index ["member_id"], name: "index_completed_gaps_on_member_id", using: :btree
  end
  ...
  create_table "members", force: :cascade do |t|
    ...
    t.index ["primary_care_physician_id"], name: "index_members_on_primary_care_physician_id", using: :btree
  end
